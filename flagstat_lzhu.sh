...
#samtools --output=%j_%x.out
#samtoolsH --error=%j_%x.err

cd /project/obds/lzhu/1_linux/2_rnaseq/1_fastq

samtools idxstats -@ 4  ERR1755084.bam > ERR1755084.idxstats
samtools flagstat -@ 4 ERR1755084.bam > ERR1755084.flagstat
