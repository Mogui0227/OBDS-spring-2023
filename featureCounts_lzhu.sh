...
#featureCounts --output=%j_%x.out
#featureCounts --error=%j_%x.err

cd /project/obds/lzhu/1_linux/2_rnaseq/1_fastq

featureCounts -t exon -T 4 -p -g gene_id \
-a /project/obds/lzhu/1_linux/2_rnaseq/2_genome/Mus_musculus.GRCm38.102.gtf.gz \
-o countsall.txt \
ERR1755084.bam ERR1755083.bam ERR1755087.bam
